...
# Location of your files. Leave blank if they're in the main directory where index.php is located. If you do decide to put the files in a seperate folder, add a trailing slash on the begin and end like so "/files/"
